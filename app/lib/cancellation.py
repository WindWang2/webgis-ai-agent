"""协作式取消原语（E-3/#894 分层收口：自 app/services/jobs/cancellation.py
原样搬移——lib 计算函数需要取消点，原位置使 lib 反向依赖 services）。

services/jobs/cancellation.py 保留 re-export 兼容既有 import 方。
"""
