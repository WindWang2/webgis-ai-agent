...
def register_project_tools(registry: ToolRegistry) -> None:
    ...
    @tool(registry,
        ...
        tags=["project", "workflow", "工作流", "保存", "计划固化", "workflow save"],
        side_effect="state_mutation",
        data_mutations=["project_memory_write"],
        required_context=["project_memory"],
        network=False,
        deterministic=False,
        latency_class="fast",
        memory_class="light",
    ...
    @tool(registry,
        ...
        tier=2, domains=["report"],
        tags=["project", "workflow", "工作流", "重跑", "rerun", "增量执行"],
        side_effect="state_mutation",
        data_mutations=["project_memory_write"],
        required_context=["project_memory"],
        deterministic=False,
        ...
        failure_modes=["timeout", "missing_data", "invalid_args"],
    )
    ...
    @tool(registry, 
        ...
        tier=2, domains=["report"],
        tags=["spatial", "quality", "数据质量", "质检", "拓扑", "geometry audit"],
    ...
    @tool(registry, 
        ...
        tier=2, domains=["report"],
        tags=["spatial", "quality", "修复", "几何修复", "make_valid", "去重", "repair"],
