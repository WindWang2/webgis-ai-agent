...
|---|---|---|---|---|---|---|---|---|
| accessibility_network | 可达性网络图 | line | line | graduated | sequential | Viridis | planned | — |
...
| anomaly_surface | 异常距平面 | raster | raster | graduated | diverging | RdBu | planned | — |
| before_after_swipe | 前后对比卷帘 | raster | raster | none | none | — | planned | — |
| bivariate_choropleth | 双变量分级统计图 | polygon | fill | graduated | sequential | Purples | planned | — |
...
| equity_assessment | 公平性评估图 | polygon | fill | graduated | diverging | RdYlGn | native | diverging_choropleth |
...
| network_centrality_map | 网络中心性图 | point/line | line | graduated | sequential | Magma | planned | — |
...
| service_area_overlay | 服务区叠加 | polygon | fill | categorical | qualitative | Set2 | native | proximity_overlay |
