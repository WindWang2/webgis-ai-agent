...
- 工具行为证据：dispatch **162** / mention 162 / none 8（dispatch 覆盖率 49%）
- findings 棘轮：**PASS**（dispatch 下限 151，当前 162；active waivers 0，过期 0，被豁免 findings 0 —— 豁免项仍在上方法量清单中可见）
